async function switchLine(lineNumber) {
	...
	myHeaders.append(
		"Cookie",
		"__cfduid=ddd8e249dcd6cce5220655528e9813aa21615584664"
	);
	...
	let url =
		...
		lineNumber +
		"/Route/Sequence/inbound?app_id=MIT%20xPro%20Homework&app_key=03cd84bdd6b540a8a6559c46c4ddf806";
	let url2 =
		"https://api.tfl.gov.uk/Line/" +
		lineNumber +
		"/Arrivals?app_id=MIT%20xPro%20Homework&app_key=03cd84bdd6b540a8a6559c46c4ddf806";
			...
			(element.itemNum = new mapboxgl.Marker()
				...
				.setPopup(
					new mapboxgl.Popup({ offset: [0, -15] }).setHTML(
						"<h3>" +
							element[1] +
							"</h3><p> Lines that service this route: <br>" +
							element[3] +
							"</p>"
					)
				)
				...
				.setPopup(
					new mapboxgl.Popup({ offset: [0, -15] }).setHTML(
						"<h3> Bus: " +
							...
							"</h5><h5>Next Stop: " +
							element.next +
							"</h5><h5>Time to next stop approx " +
							Math.round(element.time / 60, 1) +
							" minutes" +
							"</h5><h5>Line ends at: " +
							element.final +
							"</h5></p>"
